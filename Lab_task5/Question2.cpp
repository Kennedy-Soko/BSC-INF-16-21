...
void checkSubscription(int daysUntilExpiration) {
...
int main() {
    ...
    std::cout << "Enter days until subscription expiration: ";
    std::cin >> daysUntilExpiration;
    checkSubscription(daysUntilExpiration);
    return 0;
}
